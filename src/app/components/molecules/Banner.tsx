...
const Presentation = () => {
  return (
    <div className='h-[50vh] bg-Navy flex items-center justify-center'>
      <div className="max-w-7xl w-full py-10 px-5 grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="title-presentation text-CaramelExtraLight">
          <h2 className="text-8xl font-bold mb-1">This</h2>
        ...
        <div className="text-CaramelExtraLight mx-auto flex items-center justify-center leading-loose tracking-wide">
