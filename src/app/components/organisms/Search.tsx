...
const Search: React.FC<SearchProps> = ({ onSearch }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-20 mt-10 px-4 h-96 bg-search" id='search'>
      ...
      <div className="flex w-full max-w-md relative z-10">
        <input
          type="text"
          placeholder="Search..."
          className="w-full py-3 px-4 border-gray-300 focus:outline-none focus:border-blue-500 bg-white bg-opacity-70 hover:bg-opacity-90 rounded-none"
          value={searchTerm}
